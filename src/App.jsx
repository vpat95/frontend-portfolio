    ...
    <>
      ...
      <Container className="d-flex pb-xxl-5">
        <div className="contact mb-4 d-flex ms-5 ps-5 gap-3 align-items-center pb-xxl-5 mb-xxl-5">
          ...
          <a href="https://github.com/vpat95" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="2rem" height="2rem"><linearGradient id="rL2wppHyxHVbobwndsT6Ca" x1="4" x2="44" y1="23.508" y2="23.508" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#4c4c4c"/><stop offset="1" stop-color="#343434"/></linearGradient>
          ...
          <a href="https://www.linkedin.com/in/vivek-patel-533a6416b/" target="_blank">
